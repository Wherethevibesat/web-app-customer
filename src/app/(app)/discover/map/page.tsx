...
export default async function DiscoverMapPage() {
      ...
      <section className="mt-12">
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {neighborhoods.map((n) => (
            <Link
              key={n.slug}
              href={`/discover/neighborhoods/${n.slug}`}
              className="rounded-xl border border-wtva-dark-300 bg-wtva-card p-5 transition-colors hover:border-foreground"
            >
