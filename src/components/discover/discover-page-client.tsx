...
import type { BrowseFilters } from "@/lib/filter-url";
...
export function DiscoverPageClient({
  ...
  useEffect(() => {
    ...
    if (section === "areas" || section === "events" || section === "filters") {
      setFiltersOpen(true);
    }
  }, [searchParams]);
    ...
    <div className="mx-auto max-w-7xl px-4 py-6 lg:px-8 lg:py-8">
      ...
      <div className="mt-5 space-y-4">
        <BrowseFiltersBar
          ...
          searchPath="/discover/search"
          searchPlaceholder="Search venues, events, people…"
          filters={filters}
          ...
          onModalOpenChange={setFiltersOpen}
        />
        <DiscoverQuickBrowse onAreasClick={() => setFiltersOpen(true)} />
        <VenueCategoryChips
