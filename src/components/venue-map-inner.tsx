...
export function VenueMapInner({ venues, token }: Props) {
      ...
      >
        ...
        {active && (
          <Popup
            ...
            closeButton
            className="[&_.mapboxgl-popup-content]:!bg-wtva-card [&_.mapboxgl-popup-content]:!text-foreground [&_.mapboxgl-popup-content]:!rounded-lg [&_.mapboxgl-popup-content]:!border [&_.mapboxgl-popup-content]:!border-wtva-dark-300"
          >
